...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\BienType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\BienType']) ? $this->services['AppBundle\\Form\\BienType'] : ($this->services['AppBundle\\Form\\BienType'] = new \AppBundle\Form\BienType())) && false ?: '_'};
}, 'AppBundle\\Form\\ChantierType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\ChantierType']) ? $this->services['AppBundle\\Form\\ChantierType'] : ($this->services['AppBundle\\Form\\ChantierType'] = new \AppBundle\Form\ChantierType())) && false ?: '_'};
}, 'AppBundle\\Form\\ColorisParquetType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\ColorisParquetType']) ? $this->services['AppBundle\\Form\\ColorisParquetType'] : ($this->services['AppBundle\\Form\\ColorisParquetType'] = new \AppBundle\Form\ColorisParquetType())) && false ?: '_'};
}, 'AppBundle\\Form\\SupplementParquetType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\SupplementParquetType']) ? $this->services['AppBundle\\Form\\SupplementParquetType'] : ($this->services['AppBundle\\Form\\SupplementParquetType'] = new \AppBundle\Form\SupplementParquetType())) && false ?: '_'};
}, 'AppBundle\\Form\\SupplementTerrasseType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\SupplementTerrasseType']) ? $this->services['AppBundle\\Form\\SupplementTerrasseType'] : ($this->services['AppBundle\\Form\\SupplementTerrasseType'] = new \AppBundle\Form\SupplementTerrasseType())) && false ?: '_'};
